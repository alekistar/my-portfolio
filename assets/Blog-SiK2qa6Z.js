...
**Get in touch.** WhatsApp me, and let's discuss how we can get your system running.
      `},{id:2,title:"Applying IB Math HL Calculus to Optimize Algorithms",excerpt:"Discover how advanced mathematics from the IB curriculum can be applied to solve real-world algorithmic problems. Learn optimization techniques that improve application performance.",date:"Jan 25, 2026",author:"Alex Opiyo",readTime:"12 min read",category:"Tech Deep Dive",tags:["Algorithms","Calculus","Optimization","Performance"],image:"📊",gradient:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",slug:"ib-math-algorithms"},{id:3,title:"Why Kenyan SMEs Need Custom Websites, Not Just Facebook Pages",excerpt:"A business case for why small and medium enterprises in Kenya should invest in professional websites. Learn how a custom website can increase revenue and build credibility.",date:"Jan 20, 2026",author:"Alex Opiyo",readTime:"6 min read",category:"Business",tags:["Kenya","SME","Website","Business Growth","Digital"],image:"🚀",gradient:"linear-gradient(135deg, #f093fb 0%, #f5576c 100%)",slug:"kenyan-smes-custom-websites"}];return e.jsx("section",{id:"blog",className:`blog ${s?"dark":"light"}`,children:e.jsxs("div",{className:"blog-container",children:[e.jsxs(t.div,{className:"section-header",initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},children:[e.jsxs("h2",{className:"section-title",children:["Latest ",e.jsx("span",{className:"gradient-text",children:"Insights"})]}),e.jsx("p",{className:"section-subtitle",children:"Technical tutorials, business insights, and expert advice for Kenyan entrepreneurs"})]}),e.jsx("div",{className:"articles-grid",children:n.map((a,i)=>e.jsxs(t.article,{className:"article-card",initial:{opacity:0,y:50},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{delay:i*.15,duration:.6},whileHover:{y:-10,transition:{duration:.3}},children:[e.jsx("div",{className:"article-image",style:{background:a.gradient},children:e.jsx("span",{className:"article-emoji",children:a.image})}),e.jsxs("div",{className:"article-content",children:[e.jsxs("div",{className:"article-meta",children:[e.jsx("span",{className:"category-badge",style:{background:a.gradient},children:a.category}),e.jsx("span",{className:"read-time",children:a.readTime})]}),e.jsx("h3",{className:"article-title",children:a.title}),e.jsx("p",{className:"article-excerpt",children:a.excerpt}),e.jsx("div",{className:"article-tags",children:a.tags.slice(0,3).map((o,r)=>e.jsx("span",{className:"article-tag",children:o},r))}),e.jsxs("div",{className:"article-footer",children:[e.jsxs("div",{className:"article-author",children:[e.jsx(c,{className:"icon"}),e.jsx("span",{children:a.author})]}),e.jsxs("div",{className:"article-date",children:[e.jsx(l,{className:"icon"}),e.jsx("span",{children:a.date})]})]}),e.jsx(t.div,{whileHover:{scale:1.05,x:5},whileTap:{scale:.95},children:e.jsxs(d,{to:`/blog/${a.slug}`,className:"read-more-btn",children:["Read Article",e.jsx(m,{})]})})]})]},a.id))}),e.jsxs(t.div,{className:"blog-cta",initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},children:[e.jsx("p",{children:"Want to learn more about web development for Kenyan businesses?"}),e.jsx("p",{className:"cta-subtext",children:"Subscribe to get new insights delivered to your inbox."})]})]})})};export{g as default};
